...
static struct gpio_init_data t0_init_gpios[] = {
	...
	{EXYNOS4_GPY2(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1}, /* NC */
#if defined(CONFIG_MACH_T0_EUR_OPEN) || defined(CONFIG_MACH_T0_CHN_OPEN) \
	|| defined(CONFIG_MACH_T0_CHN_CMCC) || defined(CONFIG_MACH_T0_CHN_CTC) \
	|| defined(CONFIG_MACH_T0_CHN_OPEN_DUOS) || defined(CONFIG_MACH_T0_CHN_CU_DUOS)
...
#endif
#if defined(CONFIG_MACH_T0_CHN_CTC)
	{EXYNOS4212_GPM4(4), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1}, /* NC */
	{EXYNOS4212_GPM4(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1}, /* NC */
	...
	{EXYNOS4_GPF0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1}, /* FPGA2_CRESET_B */

	{EXYNOS4_GPF0(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1}, /* FPGA1_CRESET_B */
#endif
};
...
static unsigned int t0_sleep_gpio_table[][3] = {
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPA0(6),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* PEN_SDA_1.8V */
	{EXYNOS4_GPA0(7),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP}, /* PEN_SCL_1.8V */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPB(2),   S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* NC */
	{EXYNOS4_GPB(3),   S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* NC */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPC0(2),  S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN}, /* PLD_SPI_CS1 */
#else
...
#else
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPC0(3),  S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN}, /* APMDM_INT1 */
#else
	{EXYNOS4_GPC0(3),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE}, /* APMDM_INT1 */
#endif
#endif
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPC0(4),  S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN}, /* APMDM_INT2 */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPF0(5),  S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE}, /* MDM_OFF */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPF1(1),  S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN}, /* AUDIO_PCM_SEL */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) \
	|| defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPF2(3),  S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN}, /* PLD2_RST */
	{EXYNOS4_GPF2(4),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE}, /* BOOT_SW_SEL_CP2 */
#else
	...
	{EXYNOS4_GPF3(5),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* NC */
#else
	{EXYNOS4_GPF3(4),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE}, /* BOOT_SW_SEL_CP1 */
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPL2(1),  S3C_GPIO_SLP_INPUT,  S3C_GPIO_PULL_DOWN}, /* CP_RST */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPL2(5),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* AP2MDM_PON_RESET_N */
#else
	...
	{EXYNOS4_GPY0(0),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, /* PLD_CS0 */
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPY0(1),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* PLD_CS1 */
#else
	{EXYNOS4_GPY0(1),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, /* PLD_CS1 */
#endif
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPY2(3),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* AP2MDM_PMIC_RESET_N */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) || defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4212_GPM3(3),  S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, /* NC */
#else
...
#if defined(CONFIG_MACH_T0_CHN_CU_DUOS) \
		|| defined(CONFIG_MACH_T0_CHN_OPEN_DUOS)
	{EXYNOS4_GPY0(0),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, /* PLD_CS0_N */
#else
